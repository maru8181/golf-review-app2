...
class MembersControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'cureent_user should get show' do
    ...
    assert_select 'a[href=?]', edit_user_registration_path, count: 2
    assert_select 'a[href=?]', member_path(@user), count: 1
    assert_select 'a[href=?]', follow_tweet_tweets_path, count: 2
    assert_select 'a[href=?]', new_tweet_path, count: 2
  end
